...
android {
    namespace = "io.rank5.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "io.rank5.app"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
        ...
        buildConfigField(
            ...
            "\"502849293667-6jq9gcriej5buaq06n7ttkvgvalpvui8.apps.googleusercontent.com\"",
        )
    }
    ...
    sourceSets {
        getByName("main").assets.srcDir("../../server/internal/decks/data")
    }
    packaging {
        resources {
